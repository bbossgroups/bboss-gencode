...
.ditch-tab-skin-amethyst .ditch-unfocused .ditch-tab-bg-left {
			background:transparent url(<%=request.getContextPath()%>/include/amethyst_tab_bg_left.gif) 0 0 no-repeat;
			
			}
.ditch-tab-skin-amethyst .ditch-focused .ditch-tab-bg-left {
			background:transparent url(<%=request.getContextPath()%>/include/amethyst_tab_bg_white_left.gif) 0 0 no-repeat;
			height:25px;
			}
<%}%>
...
.ditch-tab-skin-sany .ditchnet-tab-container {
			margin:10px;
			}
	
.ditch-tab-skin-sany .ditch-tab-wrap {
			z-index:10;
			font:12px "Lucida Grande",LucidaGrande,Verdana,sans-serif;
			}
	
.ditch-tab-skin-sany .ditch-tab {
			position:relative;
			float:left;
			padding:0 20px;
...
.ditch-tab-skin-sany .ditch-tab a{
			height:25px;
			line-height:25px;
}

.ditch-tab-skin-sany .ditch-tab-bg-left {
			position:absolute;
			left:0; top:0;
			width:10px; 
			height:25px;
			}
html>body .ditch-tab-skin-sany .ditch-tab-bg-left {
<%
	if(isMac)
	{
	...
	{
		out.print("height:25px;");
	}
%>

			}

.ditch-tab-skin-sany .ditch-unfocused {
			color:#000;
...
<%
	...
	{%>
		background:transparent url(<%=request.getContextPath()%>/include/sany_tab_bg_right.gif) 100% 0 no-repeat;
	<%}
%>
	
			}
	
.ditch-tab-skin-sany .ditch-focused {
			border-bottom:1px solid white;
	...
	{%>
		background:transparent url(<%=request.getContextPath()%>/include/sany_tab_bg_white_right.gif) 100% 0 no-repeat;
...
.ditch-tab-skin-sany .ditch-focused a{color:#2073DD;font-weight:bold;}

.ditch-tab-skin-sany .ditch-unfocused .ditch-tab-bg-left {
			background:transparent url(<%=request.getContextPath()%>/include/sany_tab_bg_left.gif) 0 0 no-repeat;
			}
.ditch-tab-skin-sany .ditch-focused .ditch-tab-bg-left {
			background:transparent url(<%=request.getContextPath()%>/include/sany_tab_bg_white_left.gif) 0 0 no-repeat;
			}
<%}%>
...
.ditch-tab-skin-sany .ditch-tab a:link,
.ditch-tab-skin-sany .ditch-tab a:visited {
			color:#2073DD;
			text-decoration:none;
			}
			

.ditch-tab-skin-sany .ditch-tab-wrap .ditch-unfocused a:link,
.ditch-tab-skin-sany .ditch-tab-wrap .ditch-unfocused a:visited {
			color:black;
			}



.ditch-tab-skin-sany .ditch-tab-pane-wrap {
			position:relative;
			z-index:9;			
			padding:8px 0;
			}

.ditch-tab-skin-sany .ditch-tab-pane {
			overflow:auto;
			}
	
.ditch-tab-skin-sany br.ditch-clear {
			clear:both;
			}