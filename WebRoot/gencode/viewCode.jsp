...
<link href="../assets/global/fonts/font.css" rel="stylesheet"
	type="text/css" />
<link
...
<link rel="stylesheet" type="text/css"
	href="../assets/global/plugins/bootstrap-gtreetable/bootstrap-gtreetable.min.css" />
...
<script>
	(function() {
		var sourceBaseUrl = "../assets/global/plugins/carousel-owl-carousel/assets/js/google-code-prettify/";

		var styles = [ "prettify.css" ];

		for (var i = 0; i < styles.length; ++i) {
			document
					.write("<link rel=\"stylesheet\" href=\"" + sourceBaseUrl + styles[i] + "\">");
		}
	})();
</script>
<link
...
<link href="../assets/admin/layout/css/layout.css" rel="stylesheet"
	type="text/css" />
<link id="style_color"
	href="../assets/admin/layout/css/themes/light2.css" rel="stylesheet"
	type="text/css" />
...
<body
	...
	<div id="ajax-modal" class="modal  container fade modal-scroll">
	</div>
	<!-- BEGIN HEADER -->
	<div class="page-header navbar navbar-fixed-top">
		...
		<div class="page-header-inner">
			<!-- BEGIN LOGO -->
			<div class="page-logo">
				<a href="../templates/admin/index.html" target="_admin"> <img
			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						<li><i class="fa fa-home"></i> <a href="index.page">首页</a> <i
					...
					<div class="col-md-12">
						...
						<div class="portlet light bordered">
							<div class="portlet-title">
								<div class="caption font-purple-plum">
									<i class="icon-speech font-purple-plum"></i> <span
										class="caption-subject bold uppercase">${modulename }</span> <span
										class="caption-helper">查看源代码</span>
								</div>
								<div class="actions">
									<div class="btn-group">

										<button type="button" class="btn green" id="downcode"
											onclick="window.open('downcode.page?genid=${genid }','_blank')">代码下载</button>
							...
							<div class="portlet-body">
								<table class="table table-hover table-light gtreetable"
									id="gtreetable">
									<thead>
										<tr>
											<th>源码管理</th>
	...
	<div class="page-footer">
		<div class="page-footer-inner">2014 &copy; Gencode by BBoss.<script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1254131450'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s11.cnzz.com/z_stat.php%3Fid%3D1254131450%26show%3Dpic2' type='text/javascript'%3E%3C/script%3E"));</script></div>
...
<![endif]-->
	<script src="../assets/global/plugins/jquery-1.11.2.js"
	...
	<script
		...
		type="text/javascript"></script>
	<script type="text/javascript"
		src="../assets/global/plugins/bootstrap-gtreetable/bootstrap-gtreetable.js"></script>
	...
	<script src="../assets/global/plugins/jquery.form.js"
		type="text/javascript"></script>
	<script>
		(function() {
			var sourceBaseUrl = "../assets/global/plugins/carousel-owl-carousel/assets/js/google-code-prettify/";
			var sources = [ "prettify.min.js" ];

			for (var i = 0; i < sources.length; ++i) {
				document
						.write("<script src=\"" + sourceBaseUrl + sources[i] + "\"><\/script>");
			}
