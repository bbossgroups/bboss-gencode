...
public class ToUpdateMethodBodyGenerate implements MethodBodyGenerate {
	...
	public void gen(Method method, String entityName, String entityVarName,
			...
			throws Exception {
		Template addmethodbodytempalte = VelocityUtil.getTemplate("gencode/java/body/toupdate.vm");
