...
//					if(_8.type.indexOf('select')>-1){
//						$(_8).removeClass("validatebox-init");
//					}
					_a.validating = true;
					_a.value = undefined;					
				(function() {
					...
					if (_9.hasClass("validatebox-invalid")) {
						...
						if(_8.type.indexOf('select')>-1){
							$(_8).validatebox("validate");
//							$(_8).validatebox("validate").addClass("validatebox-init");
//							$(_8).blur(function(){alert('b');});
//							$(_8).focus(function(){alert('f');});
						}
					}
	...
	function _10(_11) {
		...
		if (tip) {
			...
			tip.css("top", box.offset().top
							- (_14._outerHeight() - box._outerHeight()) / 2);
	...
	$.fn.validatebox.parseOptions = function(_25) {
		var t = $(_25);
		return $.extend({}, $.parser.parseOptions(_25, ["validType",
