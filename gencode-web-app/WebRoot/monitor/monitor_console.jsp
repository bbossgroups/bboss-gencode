...
<%@ include file="/include/css.jsp"%>
	...
	<td align="center "class="thin">监控系统环境配置信息</td>
        ...
        <tr>
            <td width="20%">数据库管理</td><td><a href="../sysmanager/dbmanager/tablesmanager.jsp" target="_blank">数据库管理页面</a></td>

        </tr>
        <tr>
        <tr>
            <td width="20%">代码生成</td><td><a href="<%=request.getContextPath()%>/gencode/index.page" target="_blank">代码生成页面</a></td>
